          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="space-y-1 flex-1 min-w-0">
              ...
              <select
                ...
                disabled={busy}
                className="w-full rounded-md border border-input bg-background px-2 py-1.5 text-base focus:outline-none focus:ring-2 focus:ring-ring"
              >
                {channels.map((c) => (
        ...
        {!denyState?.open ? (
          ...
          <div className="space-y-2 rounded-lg border border-red-200 dark:border-red-900 bg-red-50/40 dark:bg-red-950/20 p-3">
            ...
            {denyState?.selected?.has('Other') && (
              <textarea
                className="w-full rounded-md border border-input bg-background px-3 py-2 text-base placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring resize-none"
                rows={2}
